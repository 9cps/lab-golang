...
func (r *ExpensesRepositoryImpl) InsertExpenses(c *gin.Context) models.Expenses {
...
func (r *ExpensesRepositoryImpl) InsertExpensesDetail(c *gin.Context) models.ExpensesDetail {
...
func (r *ExpensesRepositoryImpl) GetListMoneyCard(c *gin.Context) res_dtos.ExpensesCard {
	// SQL Query
...
func (r *ExpensesRepositoryImpl) GetListMoneyCardDetail(c *gin.Context) []models.ExpensesDetail {
